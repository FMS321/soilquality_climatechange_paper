...
#==========================================================
# Loading files
base<-read.csv("base_new_1.csv")  #climate scenario under baseline period (1986-2005)
RCP2.6_2050s<-read.csv("RCP2.6_2050_1.csv") #climate scenario of RCP2.6 during 2040-2059
RCP2.6_2100s<-read.csv("RCP2.6_2100_1.csv") #climate scenario of RCP2.6 during 2080-2099
RCP8.5_2050s<-read.csv("RCP8.5_2050_1.csv") #climate scenario of RCP8.5 during 2040-2059
RCP8.5_2100s<-read.csv("RCP8.5_2100_1.csv") #climate scenario of RCP8.5 during 2080-2099
...
for (i in 1:50) {
  ...
  base_NW_pred_all$average<- apply(base_NW_pred_all[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_NW_pred_2050s$average<- apply(RCP2.6_NW_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_NW_pred_2100s$average<- apply(RCP2.6_NW_pred_2100s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_NW_pred_2050s$average<- apply(RCP8.5_NW_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_NW_pred_2100s$average<- apply(RCP8.5_NW_pred_2100s[,3:22], 1, mean)
...
sum_RCP2.6_NW_2050s_year<- cbind(base_NW_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_NW_pred_2050s[,3:24])
names(sum_RCP2.6_NW_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_NW_2050s_year<- cbind(base_NW_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_NW_pred_2050s[,3:24])
names(sum_RCP8.5_NW_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP2.6_NW_2100s_year<- cbind(base_NW_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_NW_pred_2100s[,3:24])
names(sum_RCP2.6_NW_2100s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_NW_2100s_year<- cbind(base_NW_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_NW_pred_2100s[,3:24])
names(sum_RCP8.5_NW_2100s_year)[1:3]<- c("Soil quality", "Crop",  "Yield_base")
...
for (i in 1:50) {
  ...
  base_SW_pred_all$average<- apply(base_SW_pred_all[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_SW_pred_2050s$average<- apply(RCP2.6_SW_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_SW_pred_2100s$average<- apply(RCP2.6_SW_pred_2100s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_SW_pred_2050s$average<- apply(RCP8.5_SW_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_SW_pred_2100s$average<- apply(RCP8.5_SW_pred_2100s[,3:22], 1, mean)
...
sum_RCP2.6_SW_2050s_year<- cbind(base_SW_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_SW_pred_2050s[,3:24])
names(sum_RCP2.6_SW_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_SW_2050s_year<- cbind(base_SW_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_SW_pred_2050s[,3:24])
names(sum_RCP8.5_SW_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP2.6_SW_2100s_year<- cbind(base_SW_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_SW_pred_2100s[,3:24])
names(sum_RCP2.6_SW_2100s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_SW_2100s_year<- cbind(base_SW_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_SW_pred_2100s[,3:24])
names(sum_RCP8.5_SW_2100s_year)[1:3]<- c("Soil quality", "Crop",  "Yield_base")
...
for (i in 1:50) {
  ...
  base_NWW_pred_all$average<- apply(base_NWW_pred_all[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_NWW_pred_2050s$average<- apply(RCP2.6_NWW_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_NWW_pred_2100s$average<- apply(RCP2.6_NWW_pred_2100s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_NWW_pred_2050s$average<- apply(RCP8.5_NWW_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_NWW_pred_2100s$average<- apply(RCP8.5_NWW_pred_2100s[,3:22], 1, mean)
...
sum_RCP2.6_NWW_2050s_year<- cbind(base_NWW_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_NWW_pred_2050s[,3:24])
names(sum_RCP2.6_NWW_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_NWW_2050s_year<- cbind(base_NWW_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_NWW_pred_2050s[,3:24])
names(sum_RCP8.5_NWW_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP2.6_NWW_2100s_year<- cbind(base_NWW_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_NWW_pred_2100s[,3:24])
names(sum_RCP2.6_NWW_2100s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_NWW_2100s_year<- cbind(base_NWW_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_NWW_pred_2100s[,3:24])
names(sum_RCP8.5_NWW_2100s_year)[1:3]<- c("Soil quality", "Crop",  "Yield_base")
...
for (i in 1:50) {
  ...
  base_NEM_pred_all$average<- apply(base_NEM_pred_all[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_NEM_pred_2050s$average<- apply(RCP2.6_NEM_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_NEM_pred_2100s$average<- apply(RCP2.6_NEM_pred_2100s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_NEM_pred_2050s$average<- apply(RCP8.5_NEM_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_NEM_pred_2100s$average<- apply(RCP8.5_NEM_pred_2100s[,3:22], 1, mean)
...
sum_RCP2.6_NEM_2050s_year<- cbind(base_NEM_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_NEM_pred_2050s[,3:24])
names(sum_RCP2.6_NEM_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_NEM_2050s_year<- cbind(base_NEM_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_NEM_pred_2050s[,3:24])
names(sum_RCP8.5_NEM_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP2.6_NEM_2100s_year<- cbind(base_NEM_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_NEM_pred_2100s[,3:24])
names(sum_RCP2.6_NEM_2100s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_NEM_2100s_year<- cbind(base_NEM_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_NEM_pred_2100s[,3:24])
names(sum_RCP8.5_NEM_2100s_year)[1:3]<- c("Soil quality", "Crop",  "Yield_base")
...
for (i in 1:50) {
  ...
  base_NM_pred_all$average<- apply(base_NM_pred_all[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_NM_pred_2050s$average<- apply(RCP2.6_NM_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_NM_pred_2100s$average<- apply(RCP2.6_NM_pred_2100s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_NM_pred_2050s$average<- apply(RCP8.5_NM_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_NM_pred_2100s$average<- apply(RCP8.5_NM_pred_2100s[,3:22], 1, mean)
...
sum_RCP2.6_NM_2050s_year<- cbind(base_NM_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_NM_pred_2050s[,3:24])
names(sum_RCP2.6_NM_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_NM_2050s_year<- cbind(base_NM_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_NM_pred_2050s[,3:24])
names(sum_RCP8.5_NM_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP2.6_NM_2100s_year<- cbind(base_NM_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_NM_pred_2100s[,3:24])
names(sum_RCP2.6_NM_2100s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_NM_2100s_year<- cbind(base_NM_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_NM_pred_2100s[,3:24])
names(sum_RCP8.5_NM_2100s_year)[1:3]<- c("Soil quality", "Crop",  "Yield_base")
...
for (i in 1:50) {
  ...
  base_SM_pred_all$average<- apply(base_SM_pred_all[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_SM_pred_2050s$average<- apply(RCP2.6_SM_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_SM_pred_2100s$average<- apply(RCP2.6_SM_pred_2100s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_SM_pred_2050s$average<- apply(RCP8.5_SM_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_SM_pred_2100s$average<- apply(RCP8.5_SM_pred_2100s[,3:22], 1, mean)
...
sum_RCP2.6_SM_2050s_year<- cbind(base_SM_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_SM_pred_2050s[,3:24])
names(sum_RCP2.6_SM_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_SM_2050s_year<- cbind(base_SM_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_SM_pred_2050s[,3:24])
names(sum_RCP8.5_SM_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP2.6_SM_2100s_year<- cbind(base_SM_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_SM_pred_2100s[,3:24])
names(sum_RCP2.6_SM_2100s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_SM_2100s_year<- cbind(base_SM_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_SM_pred_2100s[,3:24])
names(sum_RCP8.5_SM_2100s_year)[1:3]<- c("Soil quality", "Crop",  "Yield_base")
...
for (i in 1:50) {
  ...
  sub_SR_YZB_train <- SR_YZB_train %>%
    select(NO, Tave, Tmax, Tmin, GDD.10, PRE, SSD, RAD, Cultivar, Soil.type, Soil.type1,
           Soil.texture, SOM, OP , AK, pH, N, P2O5, K2O, Yck, Ynpk)
...
for (i in 1:50) {
  ...
  base_SSR_pred_all$average<- apply(base_SSR_pred_all[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_SSR_pred_2050s$average<- apply(RCP2.6_SSR_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_SSR_pred_2100s$average<- apply(RCP2.6_SSR_pred_2100s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_SSR_pred_2050s$average<- apply(RCP8.5_SSR_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_SSR_pred_2100s$average<- apply(RCP8.5_SSR_pred_2100s[,3:22], 1, mean)
...
sum_RCP2.6_SSR_2050s_year<- cbind(base_SSR_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_SSR_pred_2050s[,3:24])
names(sum_RCP2.6_SSR_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_SSR_2050s_year<- cbind(base_SSR_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_SSR_pred_2050s[,3:24])
names(sum_RCP8.5_SSR_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP2.6_SSR_2100s_year<- cbind(base_SSR_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_SSR_pred_2100s[,3:24])
names(sum_RCP2.6_SSR_2100s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_SSR_2100s_year<- cbind(base_SSR_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_SSR_pred_2100s[,3:24])
names(sum_RCP8.5_SSR_2100s_year)[1:3]<- c("Soil quality", "Crop",  "Yield_base")
...
for (i in 1:50) {
  ...
  set.seed(i)
  trainingRow_ERSC <- sample(nrow(ER_SC), 0.9*nrow(ER_SC))
...
for (i in 1:50) {
  ...
  base_ER_pred_all$average<- apply(base_ER_pred_all[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_ER_pred_2050s$average<- apply(RCP2.6_ER_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_ER_pred_2100s$average<- apply(RCP2.6_ER_pred_2100s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_ER_pred_2050s$average<- apply(RCP8.5_ER_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_ER_pred_2100s$average<- apply(RCP8.5_ER_pred_2100s[,3:22], 1, mean)
...
sum_RCP2.6_ER_2050s_year<- cbind(base_ER_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_ER_pred_2050s[,3:24])
names(sum_RCP2.6_ER_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_ER_2050s_year<- cbind(base_ER_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_ER_pred_2050s[,3:24])
names(sum_RCP8.5_ER_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP2.6_ER_2100s_year<- cbind(base_ER_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_ER_pred_2100s[,3:24])
names(sum_RCP2.6_ER_2100s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_ER_2100s_year<- cbind(base_ER_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_ER_pred_2100s[,3:24])
names(sum_RCP8.5_ER_2100s_year)[1:3]<- c("Soil quality", "Crop",  "Yield_base")
...
for (i in 1:50) {
  # set train and test data(random 10%)
  set.seed(i)
  trainingRow_LRSC <- createDataPartition(LR_SC$Province,p=0.9, list = F)
...
for (i in 1:50) {
  ...
  base_LR_pred_all$average<- apply(base_LR_pred_all[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_LR_pred_2050s$average<- apply(RCP2.6_LR_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP2.6_LR_pred_2100s$average<- apply(RCP2.6_LR_pred_2100s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_LR_pred_2050s$average<- apply(RCP8.5_LR_pred_2050s[,3:22], 1, mean)
...
for (i in 1:50) {
  ...
  RCP8.5_LR_pred_2100s$average<- apply(RCP8.5_LR_pred_2100s[,3:22], 1, mean)
...
sum_RCP2.6_LR_2050s_year<- cbind(base_LR_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_LR_pred_2050s[,3:24])
names(sum_RCP2.6_LR_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_LR_2050s_year<- cbind(base_LR_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_LR_pred_2050s[,3:24])
names(sum_RCP8.5_LR_2050s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP2.6_LR_2100s_year<- cbind(base_LR_pred_all[,c("Soil.quality","Crop","average")],RCP2.6_LR_pred_2100s[,3:24])
names(sum_RCP2.6_LR_2100s_year)[1:3]<- c("Soil quality", "Crop", "Yield_base")
...
sum_RCP8.5_LR_2100s_year<- cbind(base_LR_pred_all[,c("Soil.quality","Crop","average")],RCP8.5_LR_pred_2100s[,3:24])
names(sum_RCP8.5_LR_2100s_year)[1:3]<- c("Soil quality", "Crop",  "Yield_base")
